...
class CustomTypeEncoder implements PropertyEncoder<Custom> {
    ...
    @Override
    void encode(BsonWriter writer, Custom property, Object value, EntityAccess parentAccess,
    ...
    protected static void encode(CodecRegistry codecRegistry, EncoderContext encoderContext, BsonWriter writer,
            PersistentProperty property, CustomTypeMarshaller marshaller, value) {
