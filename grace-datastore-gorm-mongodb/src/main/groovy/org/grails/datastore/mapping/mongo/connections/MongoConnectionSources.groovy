...
/**
 *
 * A {@link org.grails.datastore.mapping.core.connections.ConnectionSources} implementation that reads the
 * connections from MongoDB
 *
...
class MongoConnectionSources extends InMemoryConnectionSources<MongoClient, MongoConnectionSourceSettings> {
    ...
    MongoConnectionSources(ConnectionSource<MongoClient, MongoConnectionSourceSettings> defaultConnectionSource,
            ConnectionSourceFactory<MongoClient, MongoConnectionSourceSettings> connectionSourceFactory,
    ...
    @Override
    ConnectionSource<MongoClient, MongoConnectionSourceSettings> addConnectionSource(String name,
            PropertyResolver configuration) {
    ...
    protected MongoCollection<Document> getConnectionsCollection(
