...
class DefaultSortOrderSpec extends GormDatastoreSpec {
    ...
    void 'Test that default sort order works correctly'() {
        ...
        (2..10).each {
            new SOBook(title: 'The History of the English Speaking People volume ' + it,
                    published: new Date(), isbn: it).save(flush: true)
        }
        new SOBook(title: 'The History of the English Speaking People volume 1', published: new Date(), isbn: 1)
                .save(flush: true)
