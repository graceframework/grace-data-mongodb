...
Executes a MongoDB https://www.mongodb.com/docs/manual/reference/operator/query/nearSphere/[$nearSphere] query
...
See the documentation for the https://www.mongodb.com/docs/manual/reference/operator/query/nearSphere/[$nearSphere] query operator.
