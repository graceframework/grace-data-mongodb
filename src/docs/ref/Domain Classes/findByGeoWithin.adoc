...
Executes a MongoDB https://www.mongodb.com/docs/manual/reference/operator/query/geowithin/[$geoWithin] query
...
See https://www.mongodb.com/docs/manual/reference/operator/query/geowithin/[$geoWithin] for more information.
