...
Executes a MongoDB https://www.mongodb.com/docs/manual/reference/operator/query/geointersects/[$geoIntersects] query
...
The $geoIntersects operator is a geospatial query operator that selects all locations that intersect with a GeoJSON object. See https://www.mongodb.com/docs/manual/reference/operator/query/geointersects/[$geoIntersects].
