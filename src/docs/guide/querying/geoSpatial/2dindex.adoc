MongoDB supports https://www.mongodb.com/docs/manual/core/indexes/index-types/geospatial/2d/#std-label-2d-index[2d indexes] that store points on a two-dimensional plane. although they are considered legacy and you should use `2dsphere` indexes instead.
