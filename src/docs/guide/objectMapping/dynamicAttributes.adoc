...
Here there are two fixed properties, `name` and `goesInPatch`, that will be persisted into the MongoDB document. Using Grace Data MongoDB you can however use dynamic properties via the Groovy subscript operator. For example:
