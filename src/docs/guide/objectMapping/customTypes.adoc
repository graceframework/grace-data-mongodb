...
GORM for MongoDB is built ontop of MongoDB's BSON encoding framework. This means it is possible to implement custom https://mongodb.github.io/mongo-java-driver/5.0/bson/codecs/[Codecs] for encoding and decoding values to and from BSON.
