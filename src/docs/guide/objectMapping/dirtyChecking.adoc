...
In the case of collections and association types Grace Data MongoDB will wrap each collection in a dirty checking aware
collection type.
...
This will force Grace Data MongoDB to issue an update for the given property name.
